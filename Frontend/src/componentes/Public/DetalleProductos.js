...
const DetalleProductos = () => {
  const product = {
    name: 'Tenis Bad Bunny',
    image: 'https://res.cloudinary.com/dgbs7sg9j/image/upload/v1733268787/zapato_zy5agq.png',
    description: 'Un producto de alta calidad diseñado para satisfacer tus necesidades.',
    price: '149.99',
    category: 'Calzado',
    stock: 12,
